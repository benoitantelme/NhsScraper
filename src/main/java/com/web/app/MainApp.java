...
public class MainApp {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if (!repository.exists()) {
			boolean res = repository.mkdir();

			if (!res) {
				throw new RuntimeException("Could not create repository " + repository.getAbsolutePath());
			}
		}
	 ...
	 * @param index
	 * 
	 *            create a server with a get method to request the pages
	 *            concerning one conditions. Example:
